package com.pyne.crossword.fonts;
...
public class SmartFontGenerator {
    ...
    public static int getFontInResolution(int fontSize, int xRes, int yRes){
        float xScale = (float) (xRes/1280);
        float yScale = (float) (yRes/1080.);

        if(xScale > yScale){
            return (int) (fontSize * xScale);
        }

        return (int)(fontSize * yScale);
    }
